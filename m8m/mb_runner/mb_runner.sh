...
#
# List of the sdks is grabbed from: https://developer.garmin.com/downloads/connect-iq/sdks/sdks.json
# Based on the (Linux) ConnectIQ SDK 3.1.x
# Higher sdk removed the devices.xml file
