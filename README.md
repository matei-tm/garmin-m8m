...
[![GitHub release](https://img.shields.io/github/release/matei-tm/garmin-m8m.svg)](https://github.com/matei-tm/garmin-m8m/releases) [![Build Status](https://travis-ci.org/matei-tm/garmin-m8m.svg?branch=master)](https://travis-ci.org/matei-tm/garmin-m8m)
...
- [Table of Contents](#table-of-contents)
  ...
  - [Settings](#settings)
    ...
    - [Owl's Face color](#owls-face-color)
    - [Owl's Eyes Contour Color](#owls-eyes-contour-color)
    - [Owl's Eyes Color](#owls-eyes-color)
    - [Military format for 24 hours](#military-format-for-24-hours)
  - [Screen Legend](#screen-legend)
  - [Localization](#localization)
  - [Garmin store](#garmin-store)
